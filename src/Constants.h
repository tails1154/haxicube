...
#define GAME_APP_ALT   "HaxiCube 1.3.8 web mobile"
#define GAME_APP_NAME  "HaxiCube 1.3.8 web"
#define GAME_APP_TITLE "HaxiCube"
#else
#define GAME_APP_NAME  "HaxiCube 1.3.8"
#define GAME_APP_TITLE "HaxiCube 1.3.8"
#endif
