...
static const u8 coloured_shbin[] = {
	#embed "../../build/3ds/coloured.shbin"
};
static const u8  textured_shbin[]= {
	#embed "../../build/3ds/textured.shbin"
};
static const u8  offset_shbin[]= {
	#embed "../../build/3ds/offset.shbin"
};
...
static void AllocShaders(void) {
	Shader_Alloc(&shaders[0], coloured_shbin, sizeof(coloured_shbin));
	Shader_Alloc(&shaders[1], textured_shbin, sizeof(textured_shbin));
	Shader_Alloc(&shaders[2], offset_shbin,   sizeof(offset_shbin));
}
